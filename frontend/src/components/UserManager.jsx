...
import { Plus, Edit, Trash2, Users, UserCheck, UserX, Shield, Building, Mail, Download } from 'lucide-react'
...
export const UserManager = () => {
  const { users, deleteUser, toggleUserStatus, getActiveUsers, addUser } = useUserStore()
  ...
  const addSampleUsers = () => {
    const sampleUsers = [
      ...
      },
      {
        ...
        phone: '+1-555-0101',
        assignedGeofences: [],
        notes: 'Production Line Engineer',
      },
      {
        name: 'Mike Safety',
        ...
        phone: '+1-555-0102',
        assignedGeofences: [],
        notes: 'Safety Officer',
      },
      {
        name: 'Emma Tech',
        email: 'emma.tech@company.com',
        role: 'employee',
        department: 'it',
        phone: '+1-555-0103',
        assignedGeofences: [],
        notes: 'IT Support Specialist',
      },
      {
        name: 'David Security',
        ...
        phone: '+1-555-0104',
        assignedGeofences: [],
        notes: 'Security Personnel',
      },
    ]

    sampleUsers.forEach(user => addUser(user))
    toast.success(`${sampleUsers.length} sample users added!`)
  }
